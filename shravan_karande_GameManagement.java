 ...
 * Description: This class creates a instance of the ZyBoxLiveStore class, which is a store for video games. The main method then displays a menu for the user to choose from various options, such as adding a game to the store, etc. 
 */
